package com.liyuan.ecommerce.config;
...
@Configuration
@MapperScan(basePackages={"com.liyuan.ecommerce.mapper"},sqlSessionTemplateRef = "makeSqlSessionTemplate")
...
public class MyBatisConfiguration {
    ...
    public DataSource primaryDataSource() {
        ...
        hikariDataSource.setPoolName("eusercenter");
    ...
    public SqlSessionFactory makeSqlSessionFactoryBean(@Qualifier("dataSource")DataSource dataSource) throws Exception {
        ...
        sessionFactory.setTypeAliasesPackage("com.liyuan.ecommerce.domain");
