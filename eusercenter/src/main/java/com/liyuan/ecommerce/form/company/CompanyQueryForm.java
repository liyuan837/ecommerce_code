...
public class CompanyQueryForm extends BaseQueryForm implements Serializable {

	@ApiModelProperty(value = "主键，平台也属于商家，给定特定编号")
	private String id;

	@ApiModelProperty(value = "主键，平台也属于商家，给定特定编号列表")
